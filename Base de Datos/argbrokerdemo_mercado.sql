...
CREATE TABLE `mercado` (
  ...
  `nombreMercado` varchar(25) NOT NULL,
  `ubicacionMercado` varchar(25) NOT NULL,
  `horarioOperacionMercado` varchar(30) NOT NULL,
  `idBroker` int DEFAULT NULL,
  PRIMARY KEY (`idMercado`),
  KEY `idBroker` (`idBroker`),
  CONSTRAINT `mercado_ibfk_1` FOREIGN KEY (`idBroker`) REFERENCES `broker` (`idBroker`)
