...
CREATE TABLE `portafolio` (
  ...
  `nombrePortafolio` varchar(25) NOT NULL,
  `descripcionPortafolio` varchar(50) NOT NULL,
  `valorActualPortafolio` float NOT NULL,
  `idInversor` int DEFAULT NULL,
  PRIMARY KEY (`idPortafolio`),
  KEY `idInversor` (`idInversor`),
  CONSTRAINT `portafolio_ibfk_1` FOREIGN KEY (`idInversor`) REFERENCES `inversor` (`idInversor`)
